# Excalidraw fork packages — `v0.18.0-codertapsu.9`

Generated by `yarn fork:pack` — do not edit by hand.

Built at commit `3f34c34a`.
...
```json
"@excalidraw/excalidraw": "https://github.com/codertapsu/excalidraw/releases/download/v0.18.0-codertapsu.9/excalidraw-excalidraw-0.18.0-codertapsu.9.tgz"
```

The tarballs are published as assets on the
[`v0.18.0-codertapsu.9`](https://github.com/codertapsu/excalidraw/releases/tag/v0.18.0-codertapsu.9) release —
